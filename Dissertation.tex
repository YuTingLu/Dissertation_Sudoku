...
The way how the puzzle sequencing its three different units and the cells is basic on two principles, left to right from top to the bottom. In the puzzle, rows are counted from ${1 \dots 9}$ and sequenced from top to the bottom in the puzzle. Columns do another way round, which are sequenced from the left to the right. Blocks are a bit complicated, which use both two principles, ${1 \dots 3}$ at the top, ${4 \dots 6}$ at the medium and ${7 \dots 9}$ at the bottom, and all ordered from the left to the right. Thus, the coordinate representation for a cell is $(r_{n}, c_{n})$. The way how the cells order is like what blocks do.

To begin the technique, there is a must-do task that helps any techniques application called {``pencil-mark''} to be done first of all according the puzzle already had.
...
\multicolumn{1}{c}{} & \multicolumn{1}{c}{$c_{1}$} &  \multicolumn{1}{c}{$c_{2}$}  &  \multicolumn{1}{c}{$c_{3}$}  \\ \cline{2-4} $r_{1}$ & {\cell {}{}{}{}{}6{}{}9} &{\cell {}{}{}{}{}6{}8{}} & 1 \\ \cline{2-4}
$r_{2}$ & {\cell {}2{}{}56{}8{}}  & {\cell {}2{}{}5{}789} & 3 \\ \cline{2-4}
$r_{3}$ & {\cell {}{}{}{}5{}7{}9} & 4 & {\cell {}{}{}{}{}6{}{}9} \\ \cline{2-4}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{ c| c| }
\multicolumn{1}{c}{} &  \multicolumn{1}{c}{ $c_{n}$} \\ \cline{2-2}
$r_{1}$ & {\cell {}{}{}{}{}6{}{}9} \\ \cline{2-2}
$r_{2}$ & {\cell {}{}{}{}{}6{}8{}}\\ \cline{2-2}
$r_{3}$ & 1 \\ \cline{2-2}
$r_{4}$ & {\cell {}2{}{}56{}8{}} \\ \cline{2-2}
$r_{5}$ & {\cell {}2{}{}5{}789} \\ \cline{2-2}
$r_{6}$ & 3 \\  \cline{2-2}
$r_{7}$ & {\cell {}{}{}{}5{}7{}9} \\ \cline{2-2}
$r_{8}$ &  4 \\ \cline{2-2}
$r_{9}$ & {\cell {}{}{}{}{}6{}{}9} \\ \cline{2-2}
\end{tabular}
\end{center}
\caption{Example for Row}
\end{table}
...
$r_{n}$ & {\cell {}{}{}{}{}6{}{}9} & {\cell {}{}{}{}{}6{}8{}} & 1 & {\cell {}2{}{}56{}8{}} & {\cell {}2{}{}5{}789} & 3 & {\cell {}{}{}{}5{}7{}9} & 4 & {\cell {}{}{}{}{}6{}{}9}\\ \cline{2-10}
\end{tabular}
\end{center}
\caption{Example for Column}
\end{table}
...
\begin{center}
\begin{tabular}{c| c| }
\multicolumn{1}{c}{} & \multicolumn{1}{c}{$c_{1}$}\\ \cline{2-2}
$r_{1}$ & {\cell 123456789}\\ \cline{2-2}
\end{tabular}
\end{center}
\caption{Example for Cell}
\end{table}
...
\end{sudoku}
\label{rcExample}
\caption{Example puzzle in rc-view which is the general instance.}
\label{rcWhole}
\end{figure}
...
Figure \ref{rnWhole} is the complete rn-view example after re-permutation from rc-view Figure \ref{rcWhole}.
\begin{figure}
\begin{sudoku}
...
All the $N \times N$ cells are separated into $N$ blocks ($b_{1} \dots b_{n}$) which arranged in order from the block at top-left to the one at bottom-right ($r_{n}$ ,$c_{n}$) as what the table \ref{blockOrder} shown. Every block consists $N = n \times n$ cells, the cells in the blocks will be called as ``squares'' to be distinguished from general cells. Cells are the definition for general, the squares are indicated to the specific cell of a block. For instance, assume $N$ is $9$ and $n$ is $3$ , the block $b_{1}$ is composed of ($r_{1}$ ,$c_{1}$), ($r_{1}$ ,$c_{2}$), ($r_{1}$ ,$c_{3}$), ($r_{2}$ ,$c_{1}$), ($r_{2}$ ,$c_{2}$), ($r_{2}$ ,$c_{3}$), ($r_{3}$ ,$c_{1}$), ($r_{3}$ ,$c_{2}$), and ($r_{3}$ ,$c_{3}$), for block $b_{9}$ which is composed of ($r_{n-2}$ ,$c_{n-2}$), ($r_{n-2}$ ,$c_{n-1}$), ($r_{n-2}$ ,$c_{n}$), ($r_{n-1}$ ,$c_{n-2}$), ($r_{n-1}$ ,$c_{n-1}$), ($r_{n-1}$ ,$c_{n}$), ($r_{n}$ ,$c_{n-2}$), ($r_{n}$ ,$c_{n-1}$), and ($r_{n}$ ,$c_{n}$). In the Table \ref{Square}, each block is consisted of 9 squares which represented in order from left to right, from top to bottom, from $s_{1}\dots s_{9}$, use block and square as coordinates, we can have another representation: [b, s]. [b, s] indicates the corresponding location for (r, c).
...
For instance, in the Figure {hiddenPair}. Candidates $n_{1}$ and $n_{7}$ in $(r_{2},\ c_{7})$ are restricted to these two cells only. Once the prerequisite is satisfied, then the all other cells who has either candidates $n_{1}$ and $n_{7}$ in the cell could have these candidates cross out from these two cells.
...
In the Table \ref{hiddentriplet}, candidate $n_{2}$, $n_{5}$, and $n_{7}$, are only appeared in $c_{4}$, $c_{5}$, and $c_{7}$. Hence, all the candidates apart from $n_{2}$, $n_{5}$, and $n_{7}$ could the be eliminated from these three cells.
