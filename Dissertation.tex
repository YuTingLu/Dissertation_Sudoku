...
It is in the situation whilst three specific cells which are all in the same unit (a row, a column, or a block) and must have three candidate possibilities and no others in these three cells. In the Figure{nakedtriplet} Thus, the result that could be inferred is, those related rows, columns, and the block could remove the candidates which has same the possibilities in as these three cells.
