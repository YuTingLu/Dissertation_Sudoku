...
Hidden single rule is used in a situation that ``there is a cell which has more than one candidates in the cell, but only one candidate $v$ could be could be used in this row, this column, or this block''.  but this cell has more than one candidates. However, this technique may sometimes replaced by Cross-Hatching ??? only use defined/explained concepts!!! XXX
