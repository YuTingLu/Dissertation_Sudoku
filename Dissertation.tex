...
\section{Swordfish}
\label{sec:Swordfish}
Swordfish is an extended approach for X-wing which has really rare opportunity to apply on. It is used when, there are three different columns, c1, c2, c3, three different rows, r1, r2, r3 and a number n in a situation like :
