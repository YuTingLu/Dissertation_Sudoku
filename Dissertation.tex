...
In the Figure XXX, candidate 8 ??? is obviously the only one possibility to fill into that two cells, thus this puzzle could be simply started completing these two cells.
