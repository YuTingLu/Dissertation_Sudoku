...
It is in the situation whilst three specific cells which are all in the same unit (a row, a column, or a block) and have \textbf{only} three same candidate possibilities in these three cells. Thus, the result that could be inferred is, those related rows, columns, and the block could remove the candidates which has same the possibilities in as these three cells.
