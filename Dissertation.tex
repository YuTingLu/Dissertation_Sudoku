...
XXX First of all, there is a must-do task that helps any techniques application called {``pencil-mark''}to be done first of all according the puzzle already had. XXX
