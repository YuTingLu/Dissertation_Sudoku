...
\includegraphics[scale=0.20]{GitInit.jpg}
\label{gitinitial}
}
\subfigure[Scan the change.]{
\includegraphics[scale=0.20]{GitScan.jpg}
\label{gitscan}
}
\subfigure[Write a command for the change.]{
\includegraphics[scale=0.20]{GitCommand.jpg}
\label{gitcommand}
}
\subfigure[Stage changed.]{
\includegraphics[scale=0.20]{GitStage.jpg}
\label{gitstage}
}
\subfigure[Admit the commitment.]{
\includegraphics[scale=0.20]{GitCommit.jpg}
\label{gitcommit}
}
