...
In the block $b_{5}$ of Figure \ref{fig:hiddentriplet}, candidate $n_{5}$, $n_{6}$, and $n_{8}$, are only appeared in $c_{4}$, $c_{5}$, and $c_{7}$. Hence, all the candidates apart from $n_{2}$, $n_{5}$, and $n_{7}$ could the be eliminated from these three cells.
