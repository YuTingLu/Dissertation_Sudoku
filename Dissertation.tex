...
For the environment setting, firstly install Git and Latex. 
...
\label{sec:setup}
List the command we have used for the project. 

Viewing project history at any point you can view the history of your changes using
\begin{verbatim}
git log
\end{verbatim}

Update remote reference along with associated objects.
\begin{verbatim}
git push
\end{verbatim}
...
\includegraphics[scale=0.60]{GitScan.jpg}
\label{fig:gitscan}}
\subfigure[Write a command for the change.]{
\includegraphics[scale=0.60]{GitCommand.jpg}
\label{fig:gitcommand}}
\subfigure[Stage changed.]{
\includegraphics[scale=0.60]{GitStage.jpg}
\label{fig:gitstage}}
\subfigure[Admit the commitment.]{
\includegraphics[scale=0.60]{GitCommit.jpg}
\label{fig:gitcommit}}
\end{center}
\end{figure}
