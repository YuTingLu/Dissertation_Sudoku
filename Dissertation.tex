...
\end{itemize}
In the Figure \ref{fig:rcWhole}, we find cell $A'\ (1, 6)$ in rc-view is matched to the situation of naked single for rc-view. Thus, we have an updated annotated instance - Figure \ref{fig:rcWholeupdated}.
...
\item highlight the column $v$ in cell $A'\ (row, number)$.
\end{itemize}
In the Figure \ref{fig:rcView}, we find cell $A'\ (1, 6)$ in rc-view is matched to the situation of naked single for rc-view. Thus, we have an updated annotated instance - Figure \ref{fig:rcUpdate}.
