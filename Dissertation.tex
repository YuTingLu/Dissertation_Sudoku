...
End loop\\
\end{tabbing}
All the cells of Sudoku puzzle could be re-permutated in sequence to form an extended Sudoku board with the original one. New representations of a puzzle:
\begin{description}
...
\cite{Berthier2007Sudoku} The Hidden Logic of Sudoku
