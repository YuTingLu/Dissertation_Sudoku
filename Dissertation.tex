...
\begin{enumerate}
\item ``rc-view''  - the rows and columns of the matrix are the rows and the columns of the annotated instance.
\item ``rn-view'' (see Figure \ref{fig:rnWhole}) - the rows and numbers of the matrix are the rows and the columns of the annotated instance
\item ``cn-view'' (see Figure \ref{fig:cnWhole}) - the columns and numbers of the matrix are the rows and the columns of the annotated instance
