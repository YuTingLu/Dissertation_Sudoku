...
In the Figure \ref{fig:hiddentripletrc}, candidate $2$, $5$, and $7$ are only appeared in $c_{4}$, $c_{5}$, and $c_{7}$. Hence, all the candidates apart from $n_{2}$, $n_{5}$, and $n_{7}$ could then be excluded from these three cells.
