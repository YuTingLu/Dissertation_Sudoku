...
Figure \ref{fig:cnView} is the complete cn-view example which built from rn-view. This gives informations that one specific number with one or more row that it could possible fill in.
For example, in the Figure \ref{fig:cnView},
\begin{itemize}
